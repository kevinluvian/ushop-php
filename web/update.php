...
<body id="page-top">
	...
	<div class="container" style="padding-top: 200px; padding-bottom: 200px;">
		<div class="col12">
			...
			<tbody>
			<tr>
				<th style="text-align:left;"><strong>Products</strong></th>
			...
			<?php		
			    for ($i = 1; $i<32; $i++){
									...
									$sql = $db -> query ("SELECT * FROM productdetails WHERE id = '$i'");
									if($sql-> num_rows >0)
									{
										$row = $sql -> fetch_assoc();
									}
					...
					if(isset($_POST["proprice"])){
						...
						$sql = $db -> query("UPDATE productdetails SET price = '$price' WHERE id='$id'");
						if($sql){
