...
<div class="container" style="padding-top: 150px;">
    ...
    <div class="col12"><p style="font-weight: 700; font-size: 30px;">Apparels<br><br></p></div>
    <div class="col12">
    ...
    <ul id="filter">
                    ...
                    <li>
                        <div class="col12">
                        <p style="font-weight: 700; font-size: 20px;">Shirts</p>
                        <hr>
                        
                         <?php
    $product_array = $db_handle->runQuery("SELECT * FROM productdetails ORDER BY id ASC");
    if (!empty($product_array)) { 
        foreach($product_array as $key=>$value) if($key >=0 && $key <8){
    ?><div class="col3">
    ...
    ?>
                    ...
                    <li>
                        <div class="col12">
                        <p style="font-weight: 700; font-size: 20px;">Hoodie</p>
                        <hr>
                        <?php
    if (!empty($product_array)) { 
        foreach($product_array as $key=>$value) if($key >=8 && $key <10){
    ?><div class="col3">
            <a href="#store<?php echo $product_array[$key]["id"]; ?>"><img src="<?php echo $product_array[$key]["image"]; ?>" width="100%" style="padding-top: 15px;"></a>
            <div style="text-align: center;"><strong><?php echo $product_array[$key]["name"]; ?></strong></div>
            <div style="text-align: center;"><?php echo "$".$product_array[$key]["price"]; ?></div>
    ...
    ?>
                    ...
                    <li>
                        <div class="col12">
                        <p style="font-weight: 700; font-size: 20px;">Sports</p>
                        <hr>
                        <?php
    if (!empty($product_array)) { 
        foreach($product_array as $key=>$value) if($key >=10 && $key <15){
    ?><div class="col3">
            <a href="#store<?php echo $product_array[$key]["id"]; ?>"><img src="<?php echo $product_array[$key]["image"]; ?>" width="100%" style="padding-top: 15px;"></a>
            <div style="text-align: center;"><strong><?php echo $product_array[$key]["name"]; ?></strong></div>
            <div style="text-align: center;"><?php echo "$".$product_array[$key]["price"]; ?></div>
    ...
    ?>
            ...
            <?php
            if (!empty($product_array)) { 
                foreach($product_array as $key=>$value) if($key >=0 && $key <15){
            ?>
            <div id="store<?php echo $product_array[$key]["id"]; ?>" class="modalDialog">
                    <div>
                        <form method="post" action="apparels.php?action=add&name=<?php echo $product_array[$key]["name"]; ?>">
